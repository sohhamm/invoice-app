  ...
  return (
    <>
      ...
      <Dialog 
        ...
        backdrop={<div className={classes.dialogOverlay} />}
      >
        <h1 className={classes.dialogTitle}>
          {isMobile && (
            <div onClick={() => dialog.hide()}>
        ...
        <form>
          ...
          {isEdit ? (
            <div className={clsx(classes.footer, classes.editFooter)}>
              <Button variant='edit' onClick={handleCancel}>
                Cancel
              </Button>
            ...
            <div className={clsx(classes.footer, classes.newFooter)}>
              <Button variant='edit' overrideStyles={{width: '97px'}} onClick={handleDiscard}>
                Discard
              </Button>
